...
const mainMenu = [{
        icon: < Icon className = "menu__dashboard-icon"
        icon = "carbon:archive" / > ,
        title: "Dashboard",
        quantity: 24,
    },
    {
        icon: ( <
            Icon className = "menu__heart-icon"
    ...
    {
        icon: ( <
            Icon className = "menu__message-icon"
    ...
    {
        icon: < Icon className = "menu__favor-icon"
    ...
    {
        icon: ( <
            Icon className = "menu__list-icon"
