        ...
        <div className="card-match" onClick={redirectToProfile}>
            <div className="card-match__info">
                <div className="card-match__info--general">
                    <span>
                        {props?.match?.name}, {props?.match?.age}
                    </span>
                </div>
            ...
            <div
                className="card-match__btn card-match__btn--accept"
                onClick={(e) => {
                    e.stopPropagation();
                    e.preventDefault();
            ...
            <div
                className="card-match__btn card-match__btn--remove"
                onClick={(e) => {
                    e.stopPropagation();
                    e.preventDefault();
            ...
            <div className="card-match__bg-img">
                <img src={props?.match?.avatar} alt="" />
            </div>
        </div>
    );
}
